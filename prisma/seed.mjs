...
async function main() {
  ...
  const speciesData = [
    ...
    { commonName: "Merlin", scientificName: "Falco columbarius", category: "Raptor", description: "Small, powerful falcon. Fast, direct flight. Often chases small birds in open areas.", habitat: "Open country, coastlines, cities", imageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Beguiling%20of%20Merlin.jpg?width=640", audioUrl: "", rarity: "Uncommon", conservationStatus: "Least Concern" },
  ...
  const hotspotsData = [
    ...
    // Europe
    { name: "Doñana National Park", description: "UNESCO World Heritage wetland. Spanish Imperial Eagle, Marbled Teal, Greater Flamingo, and massive waterfowl migrations.", locationName: "Andalusia, Spain", latitude: 37.0167, longitude: -6.4500, habitatType: "Wetland", amenities: "Visitor centers, 4x4 tours, observation hides, research station", coverImage: "https://picsum.photos/seed/donana-national-park/640/360" },
    { name: "Camargue", description: "Rhône delta wetlands — Europe's largest flamingo breeding colony. Slender-billed Gull, Bee-eaters, herons.", locationName: "Provence, France", latitude: 43.5667, longitude: 4.5000, habitatType: "Wetland", amenities: "Observation towers, guided tours, visitor center, cycling paths", coverImage: "https://picsum.photos/seed/camargue-france/640/360" },
    { name: "Danube Delta", description: "Europe's largest wetland. Dalmatian Pelican, Pygmy Cormorant, Red-breasted Goose, 300+ species.", locationName: "Tulcea, Romania", latitude: 45.1667, longitude: 29.1667, habitatType: "Wetland", amenities: "Boat tours, floating hotels, visitor center, bird hides", coverImage: "https://picsum.photos/seed/danube-delta/640/360" },
    { name: "Hortobágy National Park", description: "Puszta steppe grassland. Great Bustard, Saker Falcon, Aquatic Warbler, Red-footed Falcon.", locationName: "Hungary", latitude: 47.5833, longitude: 21.1667, habitatType: "Grassland", amenities: "Visitor center, guided tours, bird ringing station, shepherd museum", coverImage: "https://picsum.photos/seed/hortobagy/640/360" },
    { name: "Falsterbo", description: "Sweden's premier migration hotspot. World-class autumn raptor migration (100k+ Honey Buzzards, Sparrowhawks, Red Kites). Falsterbo Bird Observatory operates here.", locationName: "Skåne, Sweden", latitude: 55.3833, longitude: 12.8167, habitatType: "Coast", amenities: "Bird observatory, observation tower, lighthouse, guided walks, ringing demonstrations", coverImage: "https://picsum.photos/seed/falsterbo-sweden/640/360" },
    { name: "Ottenby (Öland)", description: "Southern tip of Öland island. Top passerine migration site. Ottenby Bird Observatory, huge numbers of warblers, flycatchers, thrushes in spring/autumn.", locationName: "Öland, Sweden", latitude: 56.1981, longitude: 16.4050, habitatType: "Coast", amenities: "Bird observatory, lighthouse, nature center, walking trails, ringing demonstrations", coverImage: "https://picsum.photos/seed/ottenby-oland/640/360" },
    { name: "Lake Tåkern", description: "Ramsar wetland, one of Europe's most important bird lakes. 270+ species. Massive waterfowl staging, Black Tern colony, White-tailed Eagle, Bittern.", locationName: "Östergötland, Sweden", latitude: 58.3500, longitude: 14.8333, habitatType: "Wetland", amenities: "Visitor center (Naturum Tåkern), bird towers, boardwalks, hides, guided tours", coverImage: "https://picsum.photos/seed/lake-takern/640/360" },
    { name: "Hornborgasjön", description: "Famous crane lake. 20,000+ Eurasian Cranes stage here in spring. Also Whooper Swan, Bean Goose, White-tailed Eagle, wetland passerines.", locationName: "Västergötland, Sweden", latitude: 58.3167, longitude: 13.5667, habitatType: "Wetland", amenities: "Visitor center (Naturum Hornborgasjön), crane watching towers, hides, trails", coverImage: "https://picsum.photos/seed/hornborgasjon/640/360" },
    { name: "Gete (Öland)", description: "Northwest Öland migration hotspot. Excellent for raptors, passerines, and seabird passage. Gete Bird Observatory, coastal meadows, alvar grassland.", locationName: "Öland, Sweden", latitude: 56.7500, longitude: 16.5333, habitatType: "Coast", amenities: "Bird observatory, observation tower, meadow trails, ringing demonstrations", coverImage: "https://picsum.photos/seed/gete-oland/640/360" },
    { name: "Kullaberg Nature Reserve", description: "Dramatic coastal cliffs in NW Skåne. Seabird colonies (Guillemot, Razorbill), Peregrine, Raven, migrant passerines, rarities.", locationName: "Skåne, Sweden", latitude: 56.3000, longitude: 12.4667, habitatType: "Coast", amenities: "Lighthouse, hiking trails, bird hides, boat tours, visitor info", coverImage: "https://picsum.photos/seed/kullaberg/640/360" },
    { name: "Landsort (Öja)", description: "Southernmost point of Stockholm archipelago. Top migration site. Landsort Bird Observatory, huge passerine/seabird numbers, rarities.", locationName: "Södermanland, Sweden", latitude: 58.7333, longitude: 17.8667, habitatType: "Coast", amenities: "Bird observatory, lighthouse, ringing station, trails, accommodation", coverImage: "https://picsum.photos/seed/landsort-oja/640/360" },
    { name: "Tyresta National Park", description: "Primeval forest near Stockholm. Black Woodpecker, Three-toed Woodpecker, Pygmy Owl, Capercaillie, Hazel Grouse.", locationName: "Stockholm County, Sweden", latitude: 59.1833, longitude: 18.3000, habitatType: "Forest", amenities: "Trails, bird towers, visitor center, primeval forest, camping", coverImage: "https://picsum.photos/seed/tyresta/640/360" },
    { name: "Store Mosse National Park", description: "Largest bog south of Lapland. Golden Plover, Crane, Whooper Swan, Short-eared Owl, Red-throated Diver on lakes.", locationName: "Jönköping County, Sweden", latitude: 57.2833, longitude: 13.9500, habitatType: "Wetland", amenities: "Visitor center (Naturum Store Mosse), boardwalks, bird towers, trails", coverImage: "https://picsum.photos/seed/store-mosse/640/360" },
    { name: "Sjaunja Nature Reserve", description: "Vast mire complex in Norrbotten. Whooper Swan, Bean Goose, Golden Eagle, Gyrfalcon, Siberian Jay, Arctic warblers.", locationName: "Norrbotten, Sweden", latitude: 66.5000, longitude: 20.5000, habitatType: "Wetland", amenities: "Wilderness cabins, bird towers, hiking trails, guided tours in summer", coverImage: "https://picsum.photos/seed/sjaunja/640/360" },

    // Africa
    { name: "Kruger National Park", description: "Iconic savanna park. Southern Ground Hornbill, Kori Bustard, Martial Eagle, 500+ species.", locationName: "Limpopo/Mpumalanga, South Africa", latitude: -24.0000, longitude: 31.5000, habitatType: "Grassland", amenities: "Rest camps, game drives, bush walks, bird hides", coverImage: "https://picsum.photos/seed/kruger-national-park/640/360" },
    { name: "Okavango Delta", description: "Inland delta oasis. Pel's Fishing Owl, Wattled Crane, Slaty Egret, African Skimmer.", locationName: "Ngamiland, Botswana", latitude: -19.3333, longitude: 22.9333, habitatType: "Wetland", amenities: "Mokoro trips, luxury lodges, walking safaris, boat safaris", coverImage: "https://picsum.photos/seed/okavango-delta/640/360" },
    { name: "Djoudj National Bird Sanctuary", description: "Saharan wetland on Senegal River. 1.5M+ migratory birds. Greater Flamingo, White Pelican, Purple Heron.", locationName: "Saint-Louis, Senegal", latitude: 16.4000, longitude: -16.2333, habitatType: "Wetland", amenities: "Boat tours, observation towers, visitor center, research station", coverImage: "https://picsum.photos/seed/djoudj-bird-sanctuary/640/360" },

    // Asia
    { name: "Keoladeo National Park (Bharatpur)", description: "UNESCO wetland. Sarus Crane, Painted Stork, Black-necked Stork, 370+ species.", locationName: "Rajasthan, India", latitude: 27.1667, longitude: 77.5000, habitatType: "Wetland", amenities: "Cycle rickshaws, boat rides, observation towers, guesthouse", coverImage: "https://picsum.photos/seed/keoladeo-bharatpur/640/360" },
    { name: "Tangkoko Nature Reserve", description: "Sulawesi endemic hotspot. Maleo, Knobbed Hornbill, Sulawesi Pitta, Kingfishers.", locationName: "North Sulawesi, Indonesia", latitude: 1.5167, longitude: 125.1833, habitatType: "Forest", amenities: "Guided hikes, homestays, ranger station, night walks", coverImage: "https://picsum.photos/seed/tangkoko/640/360" },
    { name: "Fraser's Hill", description: "Montane cloud forest. Mountain Peacock-Pheasant, Malayan Whistling Thrush, Silver-eared Mesia.", locationName: "Pahang, Malaysia", latitude: 3.7167, longitude: 101.7333, habitatType: "Forest", amenities: "Trails, bird hides, colonial bungalows, night birding", coverImage: "https://picsum.photos/seed/frasers-hill/640/360" },

    // South America
    { name: "Pantanal", description: "World's largest tropical wetland. Hyacinth Macaw, Jabiru, Greater Rhea, 650+ species.", locationName: "Mato Grosso, Brazil", latitude: -17.5000, longitude: -56.5000, habitatType: "Wetland", amenities: "Boat safaris, lodges, horseback riding, night drives", coverImage: "https://picsum.photos/seed/pantanal/640/360" },
    { name: "Manu National Park", description: "Andes-to-Amazon transect. Andean Cock-of-the-rock, Harpy Eagle, Hoatzin, 1000+ species.", locationName: "Madre de Dios, Peru", latitude: -11.8333, longitude: -71.8333, habitatType: "Forest", amenities: "Lodges, canopy tower, river trips, research stations", coverImage: "https://picsum.photos/seed/manu-national-park/640/360" },
    { name: "Los Llanos", description: "Vast seasonal floodplains. Scarlet Ibis, Orinoco Goose, Horned Screamer, Jabiru.", locationName: "Apure, Venezuela", latitude: 8.5000, longitude: -67.5000, habitatType: "Wetland", amenities: "Hato tours, wildlife photography, boat trips, rustic lodges", coverImage: "https://picsum.photos/seed/los-llanos/640/360" },

    // Oceania
    { name: "Kakadu National Park", description: "Top End wetlands & escarpments. Gouldian Finch, Red Goshawk, Hooded Parrot, 280+ species.", locationName: "Northern Territory, Australia", latitude: -12.6667, longitude: 132.5000, habitatType: "Wetland", amenities: "Cruises, rock art sites, bird hides, camping, guided tours", coverImage: "https://picsum.photos/seed/kakadu/640/360" },
    { name: "Atherton Tablelands", description: "Rainforest & crater lakes. Southern Cassowary, Golden Bowerbird, Victoria's Riflebird, 12 endemics.", locationName: "Queensland, Australia", latitude: -17.2667, longitude: 145.5000, habitatType: "Forest", amenities: "Birding lodges, canopy walkway, night spotlighting, crater lakes", coverImage: "https://picsum.photos/seed/atherton-tablelands/640/360" },
    { name: "Tiritiri Matangi Island", description: "Predator-free sanctuary. Takahe, Kokako, Stitchbird, Saddleback, Little Spotted Kiwi.", locationName: "Hauraki Gulf, New Zealand", latitude: -36.6000, longitude: 174.8833, habitatType: "Forest", amenities: "Ferry access, guided walks, visitor center, overnight stays", coverImage: "https://picsum.photos/seed/tiritiri-matangi/640/360" },
  ];
