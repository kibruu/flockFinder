...
async function main() {
  ...
  const speciesData = [
    ...
    { commonName: "Spoon-billed Sandpiper", scientificName: "Calidris pygmaea", category: "Shorebird", description: "Tiny shorebird with unique spatulate bill. One of the world's most critically endangered shorebirds. ~240 breeding pairs.", habitat: "Arctic tundra (breeding), tropical mudflats (winter)", imageUrl: "https://inaturalist-open-data.s3.amazonaws.com/photos/312548110/medium.jpg", audioUrl: "", rarity: "Accidental", conservationStatus: "Critically Endangered" },
