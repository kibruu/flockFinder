...
async function main() {
  ...
  const speciesData = [
    ...
    { commonName: "Merlin", scientificName: "Falco columbarius", category: "Raptor", description: "Small, powerful falcon. Fast, direct flight. Often chases small birds in open areas.", habitat: "Open country, coastlines, cities", imageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Falco%20columbarius%20PP.jpg?width=640", audioUrl: "", rarity: "Uncommon", conservationStatus: "Least Concern" },
    ...
    { commonName: "Spoon-billed Sandpiper", scientificName: "Calidris pygmaea", category: "Shorebird", description: "Tiny shorebird with unique spatulate bill. One of the world's most critically endangered shorebirds. ~240 breeding pairs.", habitat: "Arctic tundra (breeding), tropical mudflats (winter)", imageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Spoon-billed%20Sandpiper%20in%20Bakkhali%20April%202026%20by%20Tisha%20Mukherjee%2005.jpg?width=640", audioUrl: "", rarity: "Accidental", conservationStatus: "Critically Endangered" },
