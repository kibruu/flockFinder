...
async function main() {
  ...
  const speciesData = [
    ...
    { commonName: "Belted Kingfisher", scientificName: "Megaceryle alcyon", category: "Other", description: "Stocky, crested bird with a rattling call. Hovers over water before diving for fish.", habitat: "Rivers, lakes, estuaries, coastal waters", imageUrl: "https://cdn.birdphotoworld.com/belted-kingfisher.jpg", audioUrl: "https://cdn.birdphotoworld.com/belted-kingfisher-call.mp3", rarity: "Common", conservationStatus: "Least Concern" },
