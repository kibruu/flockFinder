import type { TripStatus, TripRsvpRole } from "./domain";
...
export interface TripDetail {
  ...
  rsvps: { id: string; userId: string; role: TripRsvpRole; createdAt: string; user: { id: string; name: string; avatarUrl: string | null; vehicleModel: string | null; vehicleSeats: number | null } }[];
  ...
  currentUser: {
    id: string;
    rsvp: { role: TripRsvpRole; createdAt: string } | null;
